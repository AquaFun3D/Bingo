...
class MobTaskManager(private val _settings: ISettings): IMobTaskManager {
    ...
    private fun overworldNormal(){
        ...
        _list.add(MobTask(Material.SNOW_GOLEM_SPAWN_EGG, "Snow Golem", EntityType.SNOW_GOLEM))
    ...
    private fun overworldHard(){
        ...
        _list.add(MobTask(Material.MOOSHROOM_SPAWN_EGG, "Mushroom Cow", EntityType.MOOSHROOM))
