...
class BingoTaskManager(private val _itemTaskManager: IItemTaskManager, private val _settings: ISettings, private val _mobTaskManager: IMobTaskManager): IBingoTaskManager {
